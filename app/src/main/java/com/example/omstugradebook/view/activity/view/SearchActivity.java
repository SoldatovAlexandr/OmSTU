...
public class SearchActivity extends AppCompatActivity {
    ...
    private void initImageView() {
        ...
        imageView.setOnClickListener(v -> searchViewModel
                .changeFavoriteSchedule(scheduleOwner, like));
    }
    ...
    private void initAutoCompleteTextView() {
        ...
        autoCompleteTextView.setAdapter(new ScheduleTypeAutoComponentAdapter(this, isNetworkConnected()));
        autoCompleteTextView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            List<ScheduleOwner> favoriteSchedule = searchViewModel.getAllFavoriteSchedule();
            setImage(checkFavoriteSchedule(name, favoriteSchedule));
        });
    }

    private boolean checkFavoriteSchedule(String name, List<ScheduleOwner> favoriteSchedule) {
        for (ScheduleOwner scheduleOwner : favoriteSchedule) {
            if (scheduleOwner.getName().equals(name)) {
                return true;
            }
        }
        return false;
